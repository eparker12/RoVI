...
module1 = a_I[,c("family_ID", "sex_baby", "mode_delivery", "place_delivery", "breastfed_child", "age_at_first_dose", "birth_weight",
               ...
               "type_house",	"water_treat_wami",  "sanitation", "kitchen",	"refrigerator",	"kitchen", 
...
module1 = module1 %>% select(-family_ID)
...
module2 = module2 %>% select(-family_ID)
...
Number who seroconverted: `r sum(outcomes$seroconv)`    
Number who shed dose 1: `r sum(outcomes$dose1_shedding)`
Number with any response: `r sum(outcomes$any_response)`
...
if (run_rf_full) {
  ...
  collated_seroconv = rbind(module1_seroconv, module2_seroconv, module3_seroconv, module4_seroconv, 
                            module4e_seroconv, module4u_seroconv)
  ...
  collated_dose1 = rbind(module1_dose1, module2_dose1, module3_dose1, module4_dose1, module4e_dose1, module4u_dose1)
  ...
  collated_IgA = rbind(module1_IgA, module2_IgA, module3_IgA, module4_IgA, module4e_IgA, module4u_IgA)
...
# IgA
IgA = data.frame(
  crossval_mean = aggregate(tst_lm_R2 ~ module, collated_IgA, function(x) c(mean = mean(x)))[,2],
  crossval_sd = aggregate(tst_lm_R2 ~ module, collated_IgA, function(x) c(sd = sd(x)))[,2],
  nvar = as.numeric(table(collated_seroconv$module))
)
write.csv(IgA, "output_module5/collated_IgA_summary.csv")

# add module names
sero$module = dose1$module = either$module = IgA$module = factor(c("demography/baseline", "exposure/antibodies", "microbiota", "all", "all (neo+)", "all (neo-)"), levels = rev(c("demography/baseline", "exposure/antibodies", "microbiota", "all", "all (neo+)", "all (neo-)")))

# seroconversion plot
p1 = plot_grid(
  modules_fig_main(sero, "seroconversion") + geom_hline(yintercept=0.5, linetype="dotted"), 
  modules_fig_extra(sero) + geom_hline(yintercept=0.5, linetype="dotted"), 
  ncol=1, align="vh", axis = "l", rel_heights = c(2,1.3)
  )

# dose 1 shedding plot
p2 = plot_grid(
  modules_fig_main(dose1, "shedding, dose 1") + geom_hline(yintercept=0.5, linetype="dotted"), 
  modules_fig_extra(dose1) + geom_hline(yintercept=0.5, linetype="dotted"), 
  ncol=1, align="vh", axis = "l", rel_heights = c(2,1.3)
  )

# either shedding plot
p3 = plot_grid(
  modules_fig_main(either, "shedding, either") + geom_hline(yintercept=0.5, linetype="dotted"), 
  modules_fig_extra(either) + geom_hline(yintercept=0.5, linetype="dotted"), 
  ncol=1, align="vh", axis = "l", rel_heights = c(2,1.3)
  )

# RV-IgA plot
p4 = plot_grid(
  modules_fig_main(IgA, "infant IgA (post-ORV)") + ylim(-0.1,0.5) + geom_hline(yintercept=0, linetype="dotted"), 
  modules_fig_extra(IgA) + ylab(bquote("cross-validation"~R^2)) + ylim(-0.1,0.5) + 
...
#### One plot with legend (to extract for manuscript figure)
```{r, fig.width=5, fig.height=3.5}
modules_fig_main(sero, "seroconversion") + geom_hline(yintercept=0.5, linetype="dotted") + theme(legend.position = "right")
```


#### Importance - infant RV-IgA post-ORV
```{r, fig.width=10, fig.height=3}
p1 = modules_importance_plot("output_module5/RF_output_importance/importance_regression_IgA_module4.csv", binary=FALSE) + ggtitle("India (all)")
p2 = modules_importance_plot("output_module5/RF_output_importance/importance_regression_IgA_module4_exposed.csv", binary=FALSE) + ggtitle("India (neo+)") 
p3 = modules_importance_plot("output_module5/RF_output_importance/importance_regression_IgA_module4_unexposed.csv", binary=FALSE) + ggtitle("India (neo-)")
...
```{r, fig.width=10, fig.height=3}
p1 = modules_importance_plot("output_module5/RF_output_importance/importance_seroconv_module4.csv") + ggtitle("India (all)")
p2 = modules_importance_plot("output_module5/RF_output_importance/importance_seroconv_module4_exposed.csv") + ggtitle("India (neo+)")
p3 = modules_importance_plot("output_module5/RF_output_importance/importance_seroconv_module4_unexposed.csv") + ggtitle("India (neo-)")
...
```{r, fig.width=10, fig.height=3}
p1 = modules_importance_plot("output_module5/RF_output_importance/importance_dose1_module4.csv") + ggtitle("India (all)")
p2 = modules_importance_plot("output_module5/RF_output_importance/importance_dose1_module4_exposed.csv") + ggtitle("India (neo+)")
p3 = modules_importance_plot("output_module5/RF_output_importance/importance_dose1_module4_unexposed.csv") + ggtitle("India (neo-)")

plot_grid(p1,p2,p3, ncol=3, align="h")
```

#### Importance - shedding at either dose
```{r, fig.width=10, fig.height=3}
p1 = modules_importance_plot("output_module5/RF_output_importance/importance_either_module4.csv") + ggtitle("India (all)")
p2 = modules_importance_plot("output_module5/RF_output_importance/importance_either_module4_exposed.csv") + ggtitle("India (neo+)")
p3 = modules_importance_plot("output_module5/RF_output_importance/importance_either_module4_unexposed.csv") + ggtitle("India (neo-)")
plot_grid(p1,p2,p3, ncol=3, align="h")
```
...
names(a)[(ncol(a)-3):ncol(a)] = c("Shannon_6w", "Observed_6w", "Shannon_10w", "Observed_10w")
...
Regression: either shedding {.hidden}
===================================== 
Column {.tabset .tabset-fade}
-------------------------------------
...
#### Baseline variables
```{r, message=FALSE}
a$outcome = factor(a$either_shedding)
a1 = subset(a, country=="India")
summary = baseline_summary(a1)
summary = rbind(summary, summarise_regression("pre_exposed", a1))
write.csv(summary, "output_module5/India_full_either.csv")
formattable(summary)
```
...
a1 = subset(a, country=="India" & pre_exposed=="yes")
summary = baseline_summary(a1)
write.csv(summary, "output_module5/India_neo+_either.csv")
formattable(summary)
```
...
summary = baseline_summary(a1)
summary = rbind(summary, summarise_regression("pre_exposed", a1))
write.csv(summary, "output_module5/Malawi_full_either.csv")
formattable(summary)
```
...
summary = baseline_summary(a1)
summary = rbind(summary, summarise_regression("pre_exposed", a1))
write.csv(summary, "output_module5/UK_full_either.csv")
formattable(summary)
```
...
```{r}
a1 = subset(a, country=="India")
a1$logMB1_IgG = log(a1$MB1_IgG)
lm = glm(either_shedding ~ place_delivery + pre_exposed + logMB1_IgG, data = a1, family=binomial)
beta = round(odds_to_rr(lm)[,3:5],2)
beta_summary = data.frame(beta_CI = paste0(format(beta[,1],nsmall=2)," (",format(beta[,2],nsmall=2),"-",format(beta[,3],nsmall=2),")"),
                          adjusted_p = format(round(summary(lm)$coefficients[,4],3),nsmall=3))
beta_summary
...
a1 = subset(a, country=="India" & pre_exposed=="yes")
a1$logMB1_IgG = log(a1$MB1_IgG)
lm = glm(either_shedding ~ sanitation + logMB1_IgG, data = a1, family=binomial)
beta = round(odds_to_rr(lm)[,3:5],2)
beta_summary = data.frame(beta_CI = paste0(format(beta[,1],nsmall=2)," (",format(beta[,2],nsmall=2),"-",format(beta[,3],nsmall=2),")"),
                          adjusted_p = format(round(summary(lm)$coefficients[,4],3),nsmall=3))
beta_summary
...
```{r}
a1 = subset(a, country=="India" & pre_exposed=="no")
lm = lm(log(BB2_IgA) ~ mode_delivery + place_delivery + type_house + water_treat_wami + log(Observed_6w), data = a1)
beta = round(exp(cbind(coef(lm), confint(lm))),2)
beta_summary = data.frame(beta_CI = paste0(beta[,1]," (",beta[,2],"-",beta[,3],")"),
                          adjusted_p = round(summary(lm)$coefficients[,4],3))
beta_summary
...
```{r}
a1 = subset(a, country=="India")
lm = glm(pre_exposed ~ mode_delivery + type_house + refrigerator, data = a1, family=binomial)
beta = round(odds_to_rr(lm)[,3:5],2)
beta_summary = data.frame(beta_CI = paste0(format(beta[,1],nsmall=2)," (",format(beta[,2],nsmall=2),"-",format(beta[,3],nsmall=2),")"),
                          adjusted_p = format(round(summary(lm)$coefficients[,4],3),nsmall=3))
beta_summary
